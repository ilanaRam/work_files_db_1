...
class DataBase:
    ...
    def __init__(self, db_name: str) -> None:
        ...
        # init of the cursor obj to execute SQL queries
...
def test_travers_path_get_all_files_existing_path_with_files(files_obj, files_path):
...
def test_travers_path_negative_cases(files_obj, incorrect_files_path):
